...
class WorkflowTest extends CIUnitTestCase
{
    ...
    public function testPesananStatusStep()
    {
        ...
        $this->assertEquals(4, pesanan_status_step('selesai'));
    ...
    public function testPesananStatusStepsCount()
    {
        ...
        $this->assertEquals('Selesai', $steps[3]['label']);
    }
    ...
    public function testPesananBadgeClassReturnsValid()
    {
        ...
        $statuses = ['baru', 'diproses', 'disetujui', 'dikirim', 'selesai', 'ditolak', 'dibatalkan'];
    ...
    {
        foreach (['baru', 'diproses', 'disetujui', 'dikirim', 'selesai'] as $status) {
